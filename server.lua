...
QBCore.Functions.CreateUseableItem("standard_cpu", function(source, item)
	local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-cryptomining:client:installCPU", source, "Standard CPU", Config.Reward["standard_cpu"])
end)

QBCore.Functions.CreateUseableItem("e2_cpu", function(source, item)
	local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-cryptomining:client:installCPU", source, "E2 CPU", Config.Reward["e2_cpu"])
end)

QBCore.Functions.CreateUseableItem("quantum_cpu", function(source, item)
	local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("qb-cryptomining:client:installCPU", source, "Quantum CPU", Config.Reward["quantum_cpu"])
end)
